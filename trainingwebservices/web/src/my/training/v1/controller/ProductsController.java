 ...
 */
package my.training.v1.controller;

import static my.training.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import my.training.formatters.WsDateFormatter;
import my.training.product.data.ProductDataList;
import my.training.product.data.SuggestionDataList;
import my.training.queues.data.ProductExpressUpdateElementData;
import my.training.queues.data.ProductExpressUpdateElementDataList;
import my.training.queues.impl.ProductExpressUpdateQueue;
import my.training.stock.CommerceStockFacade;
import my.training.util.ws.SearchQueryCodec;
import my.training.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link my.training.populator.HttpRequestReviewDataPopulator} to populate review data
