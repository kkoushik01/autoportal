 ...
 */
package my.training.core.job;

import static my.training.core.job.QuoteToExpireSoonJobPerformable.DAYS_TO_EXPIRE;
import static my.training.core.job.QuoteToExpireSoonJobPerformable.DEFAULT_DAYS_TO_EXPIRE;
